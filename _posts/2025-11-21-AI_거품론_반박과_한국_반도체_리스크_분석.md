...
베스트셀러 **["텐배거 포트폴리오"](https://link.coupang.com/a/dqX0DD){:target="_blank" rel="noopener"}**의 저자이기도 한 한동대학교 김학주 교수님께서 설명하신 내용으로, 단순히 "AI 거품이 터질 것이다/안 터질 것이다"가 아니라 **"왜 쉽게 터지기 어려운 구조인지"**와 **"한국 반도체가 직면한 실질적 리스크는 무엇인지"**를 구조적으로 살펴보겠습니다.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "AI가 거품이라는 주장은 왜 나오나요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "AI 거품론의 근거는 데이터센터 투자 대비 매출 증가 속도가 느리고, AI 서비스의 실제 수익화가 아직 초기 단계라는 점입니다. 1990년대 닷컴 버블과의 유사성도 지적됩니다. 그러나 AI는 실제 생산성 향상을 이끌고 있어 기술적 거품보다는 투자 과열 측면이 더 정확합니다."
      }
    },
    {
      "@type": "Question",
      "name": "AI 거품이 꺼지면 한국 반도체는 어떤 타격을 받나요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "AI 투자 열기가 냉각되면 HBM(고대역폭 메모리) 수요가 급감할 수 있으며, 삼성전자·SK하이닉스의 수익성이 악화될 위험이 있습니다. 특히 엔비디아 GPU 수요 둔화는 한국 메모리 반도체 시장에 직접적인 영향을 미칩니다."
      }
    },
    {
      "@type": "Question",
      "name": "AI 거품론에도 불구하고 반도체에 투자해야 할까요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "단기적 주가 변동성은 있지만, AI 인프라 수요는 구조적으로 지속될 전망입니다. 클라우드, 데이터센터, 온디바이스 AI 확산은 장기 메모리 수요를 지지합니다. 단, 고평가 구간에서의 추격 매수보다는 조정 시 분할 매수 전략이 권장됩니다."
      }
    }
  ]
}
